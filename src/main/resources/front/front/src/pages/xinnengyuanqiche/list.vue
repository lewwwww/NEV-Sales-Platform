...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"20px 10px","margin":"0px auto 0","borderColor":"#00adb5","alignItems":"center","display":"flex","borderRadius":"0px","flexWrap":"wrap","background":"#f5f5f5","borderWidth":"0px 0 0px 0","width":"100%","borderStyle":"dashed","height":"auto","order":"2"}'>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>车名</div>
        <el-input v-model="formSearch.cheming" placeholder="车名" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
      ...
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>厂商</div>
        <el-input v-model="formSearch.changshang" placeholder="厂商" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
		<div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>有无天窗</div>
        <el-select v-model="formSearch.youwutianchuang" placeholder="请选择有无天窗" :clearable="true">
          <el-option v-for="(item, index) in youwutianchuangOptions" :key="index" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
		<div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>能源类型</div>
        <el-select v-model="formSearch.nengyuanleixing" placeholder="请选择能源类型" :clearable="true">
          <el-option v-for="(item, index) in nengyuanleixingOptions" :key="index" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('xinnengyuanqiche','新增')" :style='{"cursor":"pointer","border":"0px solid #db961f","padding":"0px 15px","boxShadow":"0px 0px 0px #f8a412","margin":"0px 10px 0 0","color":"#fff","outline":"none","borderRadius":"4px","background":"linear-gradient(320deg, rgba(61,199,196,1) 0%, rgba(152,247,245,1) 80%, rgba(61,199,196,1) 100%),rgb(61,199,196)","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="primary" @click="add('/index/xinnengyuanqicheAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"100%","margin":"0","background":"none","order":"3"}'>
		...
		<div class="list2 index-pv1" :style='{"padding":"0 0px","margin":"20px 0 0","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"border":"1px solid #eee","cursor":"pointer","padding":"10px","boxShadow":"0px 0px 4px #eee","margin":"0 0 20px","display":"flex","justifyContent":"space-between","borderRadius":"4px","flexWrap":"wrap","background":"rgba(255,255,255,1)","width":"49%","fontSize":"0","position":"relative","height":"240px"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"cursor":"pointer","padding":"10px","borderColor":"#9dcde9","objectFit":"cover","borderRadius":"0","borderWidth":"6px","display":"inline-block","width":"48%","borderStyle":"dotted","height":"100%"}' v-if="item.qichetupian && item.qichetupian.substr(0,4)=='http'" :src="item.qichetupian" class="image" />
				<img :style='{"cursor":"pointer","padding":"10px","borderColor":"#9dcde9","objectFit":"cover","borderRadius":"0","borderWidth":"6px","display":"inline-block","width":"48%","borderStyle":"dotted","height":"100%"}' v-else :src="baseUrl + (item.qichetupian?item.qichetupian.split(',')[0]:'')" class="image" />
				<div class="item-info" :style='{"width":"48%","padding":"0px 10px","overflow":"hidden","display":"inline-block","height":"100%"}'>
					<div :style='{"padding":"0 10px","borderColor":"#9dcde9","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","background":"none","borderWidth":"0 0 2px","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}' class="name ">{{item.cheming}}</div>
					<div :style='{"padding":"0 10px","borderColor":"#9dcde9","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","background":"none","borderWidth":"0 0 2px","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}' class="name ">{{item.pinpaileibie}}</div>
					<div :style='{"padding":"0 10px","borderColor":"#9dcde9","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","background":"none","borderWidth":"0 0 2px","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}' class="name ">颜色:{{item.yanse}}</div>
	...
	<div class="hot" :style='{"border":"0px solid #eee","padding":"0px","margin":"20px 0 0","borderRadius":"0px","background":"none","width":"100%","height":"auto","order":"5"}'>
	  ...
	  <div :style='{"padding":"0px 0px","borderRadius":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
	    <div v-for="item in hotList" :key="item" :style='{"padding":"10px","boxShadow":"0px 0px 4px #eee","borderColor":"#eee","background":"#fff","borderWidth":"1px","width":"23%","position":"relative","borderStyle":"solid","height":"auto"}' @click="toDetail(item)">
	      <img :style='{"cursor":"pointer","padding":"10px","margin":"0","borderColor":"#9dcde9","objectFit":"cover","borderRadius":"0px","background":"none","borderWidth":"6px","display":"block","width":"100%","borderStyle":"dotted","height":"150px"}' :src="baseUrl + (item.qichetupian?item.qichetupian.split(',')[0]:'')" alt="">
	      <div :style='{"cursor":"pointer","padding":"0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.cheming}}</div>
	      <div :style='{"cursor":"pointer","padding":"0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.pinpaileibie}}</div>
	      <div :style='{"cursor":"pointer","padding":"0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.yanse}}</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      getFenlei() {
        this.$http.get('option/pinpaileibie/pinpaileibie').then(res => {
          if (res.data.code == 0) {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.cheming != '') searchWhere.cheming = '%' + this.formSearch.cheming + '%';
        ...
        if (this.formSearch.youwutianchuang != '') searchWhere.youwutianchuang = this.formSearch.youwutianchuang;
        if (this.formSearch.nengyuanleixing != '') searchWhere.nengyuanleixing = this.formSearch.nengyuanleixing;
        if (this.curFenlei != '全部') searchWhere.pinpaileibie = this.curFenlei;
        this.$http.get('xinnengyuanqiche/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
