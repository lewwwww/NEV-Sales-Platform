	...
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="更新内容" prop="gengxinneirong">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.gengxinneirong" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.gengxinneirong" label="更新内容" prop="gengxinneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.gengxinneirong"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='gengxinneirong'){
							this.ruleForm.gengxinneirong = obj[o];
							this.ro.gengxinneirong = true;
							continue;
						}
				}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gengxinneirong = this.ruleForm.gengxinneirong.replace(reg,'../../../springbootsnu6t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
