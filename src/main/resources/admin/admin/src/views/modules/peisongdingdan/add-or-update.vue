	...
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="品牌类别" prop="pinpaileibie">
					<el-input v-model="ruleForm.pinpaileibie" placeholder="品牌类别" clearable  :readonly="ro.pinpaileibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="品牌类别" prop="pinpaileibie">
					<el-input v-model="ruleForm.pinpaileibie" placeholder="品牌类别" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="应付金额" prop="yingfujine">
					<el-input v-model="ruleForm.yingfujine" placeholder="应付金额" clearable  :readonly="ro.yingfujine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="应付金额" prop="yingfujine">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="能源类型" prop="nengyuanleixing">
					<el-input v-model="ruleForm.nengyuanleixing" placeholder="能源类型" clearable  :readonly="ro.nengyuanleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="能源类型" prop="nengyuanleixing">
					<el-input v-model="ruleForm.nengyuanleixing" placeholder="能源类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="收货地址" prop="shouhuodizhi">
					<el-input v-model="ruleForm.shouhuodizhi" placeholder="收货地址" clearable  :readonly="ro.shouhuodizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="收货地址" prop="shouhuodizhi">
					<el-input v-model="ruleForm.shouhuodizhi" placeholder="收货地址" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="下单时间" prop="xiadanshijian">
					<el-input v-model="ruleForm.xiadanshijian" placeholder="下单时间" clearable  :readonly="ro.xiadanshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="下单时间" prop="xiadanshijian">
					<el-input v-model="ruleForm.xiadanshijian" placeholder="下单时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="下单备注" prop="xiadanbeizhu">
					<el-input v-model="ruleForm.xiadanbeizhu" placeholder="下单备注" clearable  :readonly="ro.xiadanbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="下单备注" prop="xiadanbeizhu">
					<el-input v-model="ruleForm.xiadanbeizhu" placeholder="下单备注" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="接单时间" prop="jiedanshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jiedanshijian" label="接单时间" prop="jiedanshijian">
					<el-input v-model="ruleForm.jiedanshijian" placeholder="接单时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="接单备注" prop="jiedanbeizhu">
					<el-input v-model="ruleForm.jiedanbeizhu" placeholder="接单备注" clearable  :readonly="ro.jiedanbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="接单备注" prop="jiedanbeizhu">
					<el-input v-model="ruleForm.jiedanbeizhu" placeholder="接单备注" readonly></el-input>
				</el-form-item>
			</template>
